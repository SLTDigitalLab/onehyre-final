...
import static com.techtop.onehyreapp.RegisterNewUserActivity.SHARED_PREFS;
...
public class WelcomexActivity extends AppCompatActivity {
    ...
    String livLoc = "79.84651166666667, 6.937011666666667";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_start.setOnClickListener(v->{
            startActivity(new Intent(WelcomexActivity.this, AmountActivity.class));
            finish();
        });
    ...
    public void setDefaultLocation() {
        ...
        if (sharedPreferences.contains("tel")) {
            ...
            new bgLocationUploader().execute(driverPhoneSP, livLoc);
        }
        editor.putString("wlc","");
        editor.apply();
    }
