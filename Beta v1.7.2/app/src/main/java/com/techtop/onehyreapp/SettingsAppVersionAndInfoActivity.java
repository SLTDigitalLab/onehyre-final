...
public class SettingsAppVersionAndInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_settings_app_version_and_info);
        getSupportActionBar().setTitle("App Version");

        appVersion = findViewById(R.id.txtViewAppVersion);
